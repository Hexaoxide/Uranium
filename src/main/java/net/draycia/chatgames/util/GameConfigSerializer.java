...
public class GameConfigSerializer implements TypeSerializer<GameConfig> {
    ...
    @Nullable
    @Override
    public GameConfig deserialize(@NonNull TypeToken<?> type, @NonNull ConfigurationNode value) throws ObjectMappingException {
    ...
    @Override
    public void serialize(@NonNull TypeToken<?> type, @Nullable GameConfig obj, @NonNull ConfigurationNode value) throws ObjectMappingException {
        if (obj == null) {
            return;
        }
